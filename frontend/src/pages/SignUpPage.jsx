...
import { UserPlus, Mail, Lock, User, ArrowRight, Loader, PhoneCall, Home, LocateFixedIcon, Calendar,  Earth } from "lucide-react";
...
const SignUpPage = () => {
	...
	return (
		<div className='flex flex-col justify-center py-20 sm:px-6 lg:px-8'>
			...
			>
				<h2 className='mt-6 text-center text-3xl font-extrabold text-purple-800'>Create your account</h2>
			</motion.div>
			...
			>
				<div className='bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10 '>
					<form onSubmit={handleSubmit} className='space-y-6'>
						...
						<div>
							<label htmlFor='Frist_Name' className='flex text-sm font-medium text-gray-300'>
								Frist Name
							</label>
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									onChange={(e) => setFormData({ ...formData, Frist_Name: e.target.value })}
						...
						<div>
							<label htmlFor='Last_Name' className='flex text-sm font-medium text-gray-300'>
								Last Name
							</label>
							<div className='mt-1 relative rounded-md shadow-sm'>
								<div className='absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none'>
						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								<div className='absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none'>
									<Earth className='h-5 w-5 text-gray-400' aria-hidden='true' />
								</div>
								<input
									id='County'
									type='text'
						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								<div className='absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none'>
									<LocateFixedIcon className='h-5 w-5 text-gray-400' aria-hidden='true' />
								</div>
								<input
									id='address'
									type='text'
						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								<div className='absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none'>
									<PhoneCall className='h-5 w-5 text-gray-400' aria-hidden='true' />
								</div>
								<input
									id='number'
									type='number'
